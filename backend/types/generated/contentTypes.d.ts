...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    enlaces_legales: Schema.Attribute.Component<'layout.menu-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    menu_links: Schema.Attribute.Component<'layout.menu-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    secciones: Schema.Attribute.DynamicZone<
      [
        'sections.slider-personalizable',
        'sections.hero',
        'sections.seccion-formulario',
        'sections.seccion-texto-imagen',
        'sections.servicios',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria_producto: Schema.Attribute.Relation<
      'manyToOne',
      'api::categoria-producto.categoria-producto'
    >;
    createdAt: Schema.Attribute.DateTime;
